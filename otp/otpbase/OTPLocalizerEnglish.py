...
SuitBrushOffs = {'f': ["My boss is going to dislike me!"],
 ...
 'ym': ["They call me the yesman because I'm yes."],
 None: ["I'm bored!",
        "I am leaving, bye.",
        'Bye bye!',
        "Go away.",
        ...
        "You don't exist.",
        "I am not here now."]}
SuitFaceoffTaunts = {'b': ['Give a donation to Donald J Trump!',
       "I am the vampire!",
 ...
 'm': ["I'm Spongebob!",
       ...
       "1924?"],
 'ms': ["You're grounded!",
        "Ever heard of the grounding?",
        "My grounding master will be proud.",
        "This is how we do it boys.",
        'Toontown Mystery? More like non mystery land.',
        'Lily is so grounded.',
        "I will calculate the grounding.",
        "I'm the Ground Hunter!",
        'Give me the papers.',
        'Sign here please.',
        'Okay, insurance is not politified.'],
 'hh': ["I'm the Shrinker Hunter!",
        "Can we activate trouble making?",
        "Ever heard of the Shrinker Hunter?",
        "Oh no! Time for plan Hunter!",
        "Don't worry.",
        'Get ready for your ways to be hunted.',
        "You looking to be hunted?",
        'Hunted.',
        'We are going to have fun.',
        'I love hunting Toons and Padawans!',
        "You're in the hunted way now!"],
 ...
 'cr': ['ATTACK!',
        "I am the Captain of this job!",
        'Prepare for destruction!',
        "May I get the promotion?",
        'No time for talking! You will be in destruction!',
        "Wanna be shortened?",
        'I am powerful I am the Captain!',
        "1 Toon VS 1 Captain, fair enough.",
        'HA HA HA HA HA!',
        "I am the Captain!"],
 'mh': ['I am the Journei Bensonadams!',
        'I am a pretty girl!',
        ...
        'Attack the Toons!!',
        "I love art, do you?",
        "Sell your famous arts here at Journei's stadium!",
        "..."],
 ...
 'mb': ['We sell bags.',
        ...
        "Remind me on why we are battling.",
        'Stop fooling around.',
        "Cogs = Winner.",
        'Ever heard of a bag?'],
 'rb': ["Baron's are Burn.",
        ...
        "I did nothing! :)",
        "Looooooool.",
        "I'm the Baron way better than Loan Sharks.",
        "Stealing isn't Illigal right?",
        'Always talk to strangers!'],
 'bs': ["I'm a mini wig.",
        "Join us for special bots.",
        'At your local news work.',
        ...
        'I did nothing! :)',
        ':)',
        "Wanna come over here and get HIT?",
        'I sense ya backstabbin!',
        "Blah, blah, blah."],
 'bw': ["Eat up.",
        "You hungry?",
        'Get those SINS!',
 ...
 'le': ["I am an Officer you know.",
        ...
        "None of this is Illigal right?",
        "Us Eagles follow the Law.",
 ...
 'sd': ["You'll never know when I'll stop.",
        'Black Riders need to be Black because of their stealth.',
        'Ever heard of the Rogue?',
        "3 Riders can defeat a Padawan alone.",
        'We Black Riders have power!',
        "Don't go over powered with us.",
        "We will chase after you all we want.",
        "You don't wanna get caught by us do you?",
        'Try not to make this too easy will you?',
        'You came here just to die! How pathetic!'],
 'f': ["I wear glasses because I'm blind.",
       "They call me Glasses Man because I wear glasses.",
       "I am hoping we are in the ladder of cogs.",
       "Ever heard of me?",
       'I wanted to go to Glasses Land!',
       "Maybe if Toons weren't so selfish, I would not wear these.",
       "You're doom!",
       "Why are we fighting? Why not talk this through?",
       'I am hoping to call The One, and throw you into the trash can!',
       "My boss is the C.E.O!",
 ...
 'ym': ["I'm the Yesman!",
        ...
        'Yes.',
        'Yes.',
        "Ever heard of the No Man?",
        "Can we argue over yes and no?",
        "Yes.",
        'Yesman = Yes..',
        "I am hoping for you to say Yes anytime!",
        "Make sure you're from yesland.",
        "We can have fun with Yes? Right?"],
 'mm': ["I'm small because I'm small!",
        "I'm small because I'm small!",
        "I'm small because I'm small!",
        "I'm small because I'm small!",
        'Ever heard of the C.E.O?',
        'Ever heard of the C.E.O?',
        "Ever heard of the C.E.O?",
        'Ever heard of the C.E.O?',
        "Ever heard of the C.E.O?",
        "Ever heard of the C.E.O?",
        'Ever heard of the C.E.O?',
        "I'm small because I have a short life.",
        "I'm small because I have a short life.",
        "I'm small because I have a short life.",
        "I'm small because I have a short life."],
 'ds': ["Don't mess with me",
        'Spin!',
        'We accept donations.',
        "We can except notifies.",
        "Don't ask me to lay off.",
        'I might have to make a few cutbacks.',
        'We can cheat right?',
        'Why do you look so down?'],
 'cc': ['Copy this. Copy that.',
        'Copy this. Copy that.',
        'Copy this. Copy that.',
        'Copy this. Copy that.',
        "...",
 ...
 'tm': ['Call this to my boss.',
        ...
        'Should I call a Telemarketer?',
        'Should I call a Telemarketer?',
        'Call this to my boss.',
        'Call this to my boss.',
        "Call this to my boss.",
        "Call this to my boss."],
 'nd': ['Hope you dropped this.',
        "Where is my Magic Hat?",
        "This is for the strong and the weak.",
        "Magic!",
        ...
        "Spread the Magic!",
        "U.S.A!",
        "Donald J Trump is the best president in the U.S.A!"],
 'gh': ['I love to wear glasses.',
 ...
 'bc': ['I enjoy subtracting Toons!',
        ...
        "Where have you bean?",
        "Where have you bean?"],
 'bf': ["Law rule section 4.2.",
        "Law rule section 4.2.",
        "Law rule section 4.2.",
        'Law rule section 4.2.',
        'Law rule section 4.2.',
        "Law rule section 4.2.",
        ...
        'Law rule section 4.2.',
        "Law rule section 4.2."],
 'tf': ["Donald J Trump is the best president in the U.S.A!",
        "Donald J Trump is the best president in the U.S.A!",
        "...",
        ...
        "Double Face Of Doom!",
        "Ever been doomed?",
        'Raise your threat by 12.',
        "Add more threat to the board.",
        "You're Doomed! Yes!",
        'Doomed time!',
        "Double Face Of Doom!"],
 'dt': ["I have 4 eyes because of my style.",
        'I have 4 eyes because of my style.',
        'I have 4 eyes because of my-\x04style.',
        "I have 4 eyes because of my style.",
        'I have 4 eyes because of my style.',
        "I have 4 eyes because of my style.",
        'I have 4 eyes because of my style.',
        ...
        'I have 4 eyes because of my style.',
        'Doubles anyone??'],
 'ac': ["I am the Chaser named after The ambulance!",
        'I am the Chaser named after The ambulance!',
        "I am the Chaser named after The ambulance!",
        'I am the Chaser named after The ambulance!',
        'I am the Chaser named after The ambulance!',
        'I am the Chaser named after The ambulance!',
