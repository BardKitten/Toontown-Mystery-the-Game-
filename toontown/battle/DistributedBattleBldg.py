...
class DistributedBattleBldg(DistributedBattleBase.DistributedBattleBase):
    ...
    def setBossBattle(self, value):
        ...
        if self.bossBattle:
            self.battleMusic = base.loadMusic('phase_7/audio/bgm/encntr_suit_winning_indoor.mp3')
        else:
            self.battleMusic = base.loadMusic('phase_7/audio/bgm/encntr_general_bg_indoor.mp3')
