...
def createSuitReviveTrack(suit, toon, battle, npcs = []):
    ...
    spinningSound = base.loadSfx('phase_3.5/audio/sfx/Cog_Death_%s.mp3' % random.randint(1, 3))
    deathSound = base.loadSfx('phase_3.5/audio/sfx/ENC_cogfall_apart_%s.mp3' % random.randint(1, 6))
