...
ElevatorData = {ELEVATOR_NORMAL: {'openTime': 3.0,
                   'closeTime': 3.0,
                   'width': 3.5,
                   'countdown': bboard.get('elevatorCountdown', 11.0),
                   'sfxVolume': 1.0,
                   'collRadius': 5},
 ELEVATOR_VP: {'openTime': 3.0,
               'closeTime': 3.0,
               'width': 11.5,
               'countdown': bboard.get('elevatorCountdown', 16.0),
               'sfxVolume': 0.7,
               'collRadius': 7.5},
 ELEVATOR_MINT: {'openTime': 3.0,
                 'closeTime': 3.0,
                 'width': 5.875,
                 'countdown': bboard.get('elevatorCountdown', 11.0),
                 'sfxVolume': 1.0,
                 'collRadius': 5},
 ELEVATOR_OFFICE: {'openTime': 3.0,
                   'closeTime': 3.0,
                   'width': 5.875,
                   'countdown': bboard.get('elevatorCountdown', 11.0),
                   'sfxVolume': 1.0,
 ...
 ELEVATOR_CFO: {'openTime': 3.0,
                ...
                'sfxVolume': 0.7,
                'collRadius': 7.5},
 ELEVATOR_CJ: {'openTime': 3.0,
               'closeTime': 3.0,
               'width': 15.8,
               'countdown': bboard.get('elevatorCountdown', 16.0),
               'sfxVolume': 0.7,
               'collRadius': 7.5},
 ELEVATOR_STAGE: {'openTime': 3.0,
                  'closeTime': 3.0,
                  'width': 6.5,
                  'countdown': bboard.get('elevatorCountdown', 11.0),
                  'sfxVolume': 1.0,
                  'collRadius': 9.5},
 ELEVATOR_BB: {'openTime': 3.0,
               'closeTime': 3.0,
               'width': 6.3,
               'countdown': bboard.get('elevatorCountdown', 16.0),
               'sfxVolume': 0.7,
               'collRadius': 7.5},
 ELEVATOR_COUNTRY_CLUB: {'openTime': 3.0,
                         'closeTime': 3.0,
                         'width': 5.875,
                         'countdown': bboard.get('elevatorCountdown', 11.0),
                         'sfxVolume': 1.0,
                         'collRadius': 4},
 ELEVATOR_FIELD: {'openTime': 3.0,
                   'closeTime': 3.0,
                   'width': 3.5,
                   'countdown': bboard.get('elevatorCountdown', 11.0),
                   'sfxVolume': 1.0,
...
INTERIOR_ELEVATOR_COUNTDOWN_TIME = 300
