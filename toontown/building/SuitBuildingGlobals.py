...
buildingChance = {
    ...
    ToontownGlobals.ElmStreet: config.GetFloat('elm-street-building-chance', 80.0),
    ToontownGlobals.MapleStreet: config.GetFloat('maple-street-building-chance', 80.0),
    ToontownGlobals.OakStreet: config.GetFloat('oak-street-building-chance', 80.0),
    ToontownGlobals.AltoAvenue: config.GetFloat('alto-avenue-building-chance', 85.0),
    ToontownGlobals.BaritoneBoulevard: config.GetFloat('baritone-boulevard-building-chance', 85.0),
    ToontownGlobals.TenorTerrace: config.GetFloat('tenor-terrace-building-chance', 85.0),
    ToontownGlobals.WalrusWay: config.GetFloat('walrus-way-building-chance', 95.0),
    ToontownGlobals.SleetStreet: config.GetFloat('sleet-street-building-chance', 95.0),
