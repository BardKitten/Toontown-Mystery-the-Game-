...
<<<<<<< HEAD
        self.battleThreeDuration = 600
=======
        self.battleThreeDuration = 1200
>>>>>>> 6b9c5bdc086b6f2266eab2cc2b56d7a5ccabfe33
    ...
    def setAttackCode(self, attackCode, avId = 0):
        ...
        if attackCode == ToontownGlobals.BossCogDizzy or attackCode == ToontownGlobals.BossCogDizzyNow:
            ...
            delayTime += self.progressValue(0, 0)
        else:
            delayTime = ToontownGlobals.BossCogAttackTimes.get(attackCode)
            if delayTime == None:
                return
        if self.dept == 's' and attackCode == ToontownGlobals.BossCogAreaAttack:
            delayTime += 2.5
