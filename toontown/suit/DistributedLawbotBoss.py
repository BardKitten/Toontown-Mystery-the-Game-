...
class DistributedLawbotBoss(DistributedBossCog.DistributedBossCog, FSM.FSM):
    ...
    def makeIntroductionMovie(self, delayDeletes):
        ...
        track = Track(
            ...
            (13, Parallel(Func(self.play, 'Ff_lookRt'), base.camera.posInterval(3.5, (-2.8, -100, 19.3), blendType='easeInOut'))),
            (13.5, Func(self.setChatAbsolute, TTLocalizer.LawbotBossTempIntro2, CFSpeech)),
            (15, self.actorInterval('Ff_lookRt', playRate=-0.5)),
            (18, Func(self.setChatAbsolute, TTLocalizer.LawbotBossTempIntro3, CFSpeech)),
            (18, self.actorInterval('Ff_neutral', playRate=-0.5)),
            (22, Func(self.setChatAbsolute, TTLocalizer.LawbotBossTempIntro4, CFSpeech)),
            (22, self.actorInterval('Ff_neutral', playRate=-0.5)),
            (26, Func(self.setChatAbsolute, TTLocalizer.LawbotBossTempIntro5, CFSpeech)),
            (26, self.actorInterval('Ff_neutral', playRate=-0.5)),
            (30, Func(self.setChatAbsolute, TTLocalizer.LawbotBossTempIntro6, CFSpeech)),
            (30, self.actorInterval('Ff_neutral', playRate=-0.5)),
            (34, Func(self.setChatAbsolute, TTLocalizer.LawbotBossTempIntro7, CFSpeech)),
            (34, self.actorInterval('Ff_neutral', playRate=-0.5)),
            (38, Func(self.setChatAbsolute, TTLocalizer.LawbotBossTempIntro8, CFSpeech)),
            (38, self.actorInterval('Ff_neutral', playRate=-0.5)),
            (41, Sequence(Func(self.loop, 'Ff_neutral'), Func(self.clearChat), self.loseCogSuits(self.toonsA + self.toonsB, render, (-2.798, -70, 10, 180, 0, 0)))),
            (44, Sequence(Func(self.setChatAbsolute, TTLocalizer.BossCogAttackToons, CFSpeech), base.camera.posHprInterval(2.0, (-2.7, -90, 0), (0, 39.7, 8.3), blendType='easeInOut'))),
            (48, Sequence()))
