...
ColdCallerHead = VBase4(0.25, 0.35, 1.0, 1.0) # Head used by Cold Caller
            ...
            # Bossbots
suitProperties = {'f': (4.0 / cSize, SuitDNA.corpPolyColor, ['gladhander'], 'bottom-feeder.jpg', 4.88),
                  'p': (3.35 / bSize, SuitDNA.corpPolyColor, ['movershaker'], 'halloween_blood-sucker.jpg', 5.0),
                  'ym': (4.125 / aSize, SuitDNA.corpPolyColor, ['yesman'], 'double-talker.jpg', 5.28),
                  'mm': (4.5 / bSize, SuitDNA.corpPolyColor, ['ambulancechaser'], '', 5.25),
                  'ds': (4.5 / aSize, VBase4(0.8, 0.7, 0.7, 1.0), ['bigwig'], '', 6.08),
                  ...
                  'tbc': (7.0 / aSize, VBase4(0.75, 0.95, 0.75, 1.0), ['bigwig'], 'name-dropper.jpg', 9.34),
                  # Lawbots
                  'bf': (4.0 / cSize, SuitDNA.legalPolyColor, ['flunky', 'glasses'], '', 4.81),
                  'b': (4.375 / bSize, VBase4(0, 0, 0, 0), ['pencilpusher'], '', 6.17),
                  'dt': (4.25 / aSize, SuitDNA.legalPolyColor, ['yesman'], '', 5.63),
                  ...
                  'le': (7.125 / aSize, VBase4(0, 0, 0, 0), ['yesman'], '', 8.27),
                  ...
                  'bc': (4.4 / bSize, SuitDNA.moneyPolyColor, ['movershaker'], 'prime-mover.jpg', 5.95),
                  'nc': (5.25 / cSize, SuitDNA.moneyPolyColor, ['gladhander'], '', 7.22),
                  ...
                  'nd': (4.35 / aSize, VBase4(0.55, 0.65, 1.0, 1.0), ['yesman'], '', 5.98),
