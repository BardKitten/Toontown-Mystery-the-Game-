...
suitProperties = {'f': (4.0 / cSize, SuitDNA.corpPolyColor, ['gladhander'], '', 4.88),
                  ...
                  'ym': (4.125 / aSize, SuitDNA.corpPolyColor, ['backstabber'], '', 5.28),
                  ...
                  # Cashbots
                  'sc': (2.0 / cSize, SuitDNA.moneyPolyColor, ['coldcaller'], 'conartist.jpg', 3.37),
                  'pp': (3.55 / bSize, VBase4(0, 0, 0, 0), ['loanshark'], '', 5.26),
