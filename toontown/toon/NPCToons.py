...
NPCToonDict = {
 ...
 2011: (2519, lnames[2011], ('dsl', 'ms', 'l', 'm', 5, 0, 5, 5, 1, 5, 1, 5, 1, 5), 'm', 1, NPC_CLERK),
 ...
 2121: (2633, lnames[2121], ('cls', 'ss', 'l', 'f', 17, 28, 17, 17, 43, 27, 82, 27, 46, 27), 'f', 0, NPC_REGULAR),
 ...
 2132: (2661, lnames[2132], ('cls', 'ms', 'l', 'f', 21, 29, 21, 21, 133, 27, 30, 27, 54, 27), 'f', 0, NPC_REGULAR),
 ...
 2308: (2801, lnames[2308], ('fsl', 'ms', 'm', 'f', 17, 0, 17, 17, 5, 28, 3, 28, 1, 28), 'f', 1, NPC_REGULAR),
 2309: (2802, lnames[2309], ('rsl', 'ls', 'm', 'm', 22, 0, 22, 22, 1, 1, 1, 1, 1, 14), 'm', 1, NPC_REGULAR),
 2311: (2809, lnames[2311], ('mss', 'ms', 'm', 'm', 19, 0, 19, 19, 99, 27, 41, 27, 3, 27), 'm', 1, NPC_REGULAR),
 ...
 1001: (1506, lnames[1001], ('csl', 'ms', 'm', 'f', 22, 22, 22, 22, 24, 28, 73, 30, 14, 27), 'f', 0, NPC_CLERK),
 ...
 1116: (1614, lnames[1116], ('dss', 'ls', 'l', 'f', 22, 27, 22, 22, 84, 27, 73, 27, 40, 27), 'f', 0, NPC_REGULAR),
 ...
 1323: (1821, lnames[1323], ('rll', 'ss', 'l', 'f', 24, 0, 24, 24, 0, 0, 0, 0, 1, 2), 'f', 0, NPC_REGULAR),
 ...
 3007: (3507, lnames[3007], ('rls', 'ls', 'l', 'f', 10, 19, 10, 10, 41, 28, 109, 28, 23, 28), 'f', 0, NPC_CLERK),
 ...
 3112: (3607, lnames[3112], ('css', 'ms', 's', 'm', 15, 0, 15, 15, 17, 29, 1, 29, 1, 29), 'm', 1, NPC_REGULAR),
 ...
 4115: (4614, lnames[4115], ('css', 'ms', 's', 'f', 18, 0, 18, 18, 1, 27, 1, 27, 1, 27), 'f', 0, NPC_REGULAR),
 ...
 4119: (4619, lnames[4119], ('css', 'ms', 'm', 'f', 6, 0, 6, 6, 5, 29, 3, 28, 1, 28), 'f', 0, NPC_REGULAR),
 ...
 4140: (4658, lnames[4140], ('cls', 'ls', 'l', 'm', 2, 0, 2, 2, 99, 27, 0, 27, 41, 27), 'm', 0, NPC_REGULAR),
...
if config.GetBool('want-new-toonhall', 1):
    NPCToonDict[2001] = (2513, lnames[2001], ('csl', 'ls', 'm', 'f', 17, 0, 17, 17, 41, 30, 22, 29, 13, 29), 'f', 1, NPC_FLIPPYTOONHALL)
else:
    NPCToonDict[2001] = (2513, lnames[2001], ('css', 'ls', 'm', 'f', 17, 17, 17, 17, 41, 30, 22, 29, 13, 29), 'f', 1, NPC_REGULAR)
...
HQnpcFriends = {
 2001: (ToontownBattleGlobals.HEAL_TRACK, 6, 500, 5),
 2132: (ToontownBattleGlobals.HEAL_TRACK, 5, ToontownGlobals.MaxHpLimit, 4),
 2121: (ToontownBattleGlobals.HEAL_TRACK, 3, 4, 0),
 2011: (ToontownBattleGlobals.TRAP_TRACK, 6, 580, 5),
 3007: (ToontownBattleGlobals.TRAP_TRACK, 4, 445, 5),
 1001: (ToontownBattleGlobals.TRAP_TRACK, 3, 395, 5),
 3112: (ToontownBattleGlobals.LURE_TRACK, 6, 0, 5),
 1323: (ToontownBattleGlobals.LURE_TRACK, 3, 0, 0),
 2308: (ToontownBattleGlobals.LURE_TRACK, 1, 0, 0),
 4119: (ToontownBattleGlobals.SOUND_TRACK, 6, 165, 5),
 4219: (ToontownBattleGlobals.SOUND_TRACK, 5, 90, 4),
 4115: (ToontownBattleGlobals.SOUND_TRACK, 4, 70, 3),
 1116: (ToontownBattleGlobals.DROP_TRACK, 5, 400, 5),
 2311: (ToontownBattleGlobals.DROP_TRACK, 4, 320, 4),
 4140: (ToontownBattleGlobals.DROP_TRACK, 2, 450, 5),
